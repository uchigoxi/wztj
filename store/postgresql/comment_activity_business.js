...
Comment.prototype.insertComment = function (comment, callback) {
  ...
  var sql = "insert into comment_activity_business (fid, comment,create_date,uid,uname,audit_user,audit_date,status) " +
...
Comment.prototype.getCommentById = function (id, callback) {
  var sql = "SELECT id,fid,comment,create_date,uid,uname,audit_user,audit_date,status " +
    "FROM comment_activity_business where id = $1 and status = 0 order by id desc";
  var options = [id];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.getCommentByFid = function (fid, callback) {
  var sql = "SELECT id,fid,comment,create_date,uid,uname,audit_user,audit_date,status " +
    "FROM comment_activity_business where fid = $1 and status = 0 order by id desc";
  var options = [fid];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.getCommentByUid = function (uid, callback) {
  var sql = "SELECT id,fid,comment,create_date,uid,uname,audit_user,audit_date,status " +
    "FROM comment_activity_business where uid = $1 and status = 0 order by id desc";
  var options = [uid];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.getCommentByStatus = function (status, callback) {
  var sql = "SELECT id,fid,comment,create_date,uid,uname,audit_user,audit_date,status " +
    "FROM comment_activity_business where status = $1 order by id desc";
  var options = [status];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.getCommentList = function (callback) {
  var sql = "SELECT id,fid,comment,create_date,uid,uname,audit_user,audit_date,status " +
    "FROM comment_activity_business  order by id desc";
  var options = [];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.setAuditInfoById = function (id, auditName, status, callback) {
  var sql = "update comment_activity_business set audit_user = $1, audit_date = now(), status = $2 where id = $3 and status = 2";
...
Comment.prototype.setStatusById = function (id, auditName, status, callback) {
  var sql = "update comment_activity_business set audit_user = $1, audit_date = now(), status = $2 where id = $3 ";
  var options = [auditName, status, id];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
...
Comment.prototype.cleanTable = function (callback) {
  var sql = "truncate table comment_activity_business";
  var options = [];
  _query(sql, options, function (err, result) {
    return callback(err, result);
  });
