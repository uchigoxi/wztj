create or replace function proc_add_goods_batch(
  ...
  p_create_date goods_pool.create_date%TYPE,
...
begin
  ...
  for i in 1..v_sn_count loop
    insert into goods_pool (name,description,sn,bid,pic,category,create_date,use_date,use_for,status,owner,sdate,edate,remark1,remark2)
      values (p_name,p_description,p_sn_array[i],p_bid,p_pic,p_category,p_create_date,p_use_date,p_use_for,p_status,p_owner,p_sdate,p_edate,p_remark1,p_remark2)
